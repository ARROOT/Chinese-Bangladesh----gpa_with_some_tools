...
int main();      int gpain();      int login();       int record();
int xrecord();   int sw();         void print();      void loginin();
void show();     void comment();   void ntog();       void registerin();
...
using namespace std;
  ...
  struct pdata
  {
    ...
    string semester, getsemester, subname, say; int file;
  }dd;
...
int login()////////////////login////////////////////////////
{
           ...
           din_u.close();
           std::ifstream dck("loginfo.dat",ios::in);
           string ck;
           getline(dck,ck);
...
{
        da;
        char lpass[200], lname[200], pas, En;
        int x;
